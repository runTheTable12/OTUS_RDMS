** Домашнее задание №4: DDL скрипты для postgres **

Созданим базу данных с названием **otus_hw**

```
create database otus_hw;
```
Создадим роль **anatolii** с правами суперпользователя.

```
create role anatolii SUPERUSER;
```

Создадим схему для проекта. 
